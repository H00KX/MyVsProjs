        ...
        case WM_INITDIALOG:
            {
                ...
                BOOL bRet = SendMessage(hComBo, CB_ADDSTRING, 0, (LPARAM)_T("C"));
                bRet = SendMessage(hComBo, CB_ADDSTRING, 0, (LPARAM)_T("D"));
                bRet = SendMessage(hComBo, CB_ADDSTRING, 0, (LPARAM)_T("E"));
                bRet = SendMessage(hComBo, CB_ADDSTRING, 0, (LPARAM)_T("F"));
                ...
                case ID_INFO:
                    {
                        //
                       //  HWND hDlg 
                        g_nResult = DialogBox(g_hInstance,
        ...
        case WM_CREATE:
            {
                ...
                hRichEdit = CreateWindowEx(WS_EX_CLIENTEDGE, TEXT("RichEdit20A"),
                                           NULL,
                                           WS_CHILD | WS_VISIBLE | WS_VSCROLL | WS_HSCROLL | \
                                           ES_MULTILINE | ES_NOHIDESEL,
                                           0, 0, 0, 0, hwnd, 0, g_hInstance, NULL);
            }
            break;
        ...
        case WM_SIZE:
            {
                ...
                MoveWindow(hRichEdit, 0, 0, stRect.right, stRect.bottom - nStatusWndHeight, TRUE);
            }
            break;
